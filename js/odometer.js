(function() {
    ...
    Odometer = (function() {
      ...
      Odometer.prototype.render = function(value) {
        ...
        _ref = Number(value.toFixed(this.format.precision).replace(odometerOptions.format ? '.' + window.odometerOptions.format.split('d').join('0').split('.')[window.odometerOptions.format.split('d').join('0').split('.').length-1] : '00', '')).toLocaleString('en-US').split('').reverse();
      ...
      Odometer.prototype.getFractionalDigitCount = function() {
        ...
        for (i = _i = 0, _len = values.length; _i < _len; i = ++_i) {
          value = values[i];
          values[i] = value.toFixed(this.format.precision).replace(odometerOptions.format ? '.' + window.odometerOptions.format.split('d').join('0').split('.')[window.odometerOptions.format.split('d').join('0').split('.').length-1] : '00', '');
